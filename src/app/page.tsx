            ...
            <div className="flex flex-wrap gap-1 items-center justify-center">
              {DATA.skills.map((skill, id) => (
                ...
                >
                  <Badge
                    key={skill.name}
                    className={`hover:cursor-default transition-all duration-300 ease-in-out ${skill.name === "Next.js" ? "hover:bg-[#FF1F5E] hover:text-white" : ""}`}
                  >
          ...
          <div className="space-y-12 w-full py-12">
            <BlurFade delay={BLUR_FADE_DELAY * 13}>
              <div className="flex flex-col items-center justify-center space-y-4 text-center">
                <div className="space-y-2">
                  <h2 className="text-3xl font-bold tracking-tighter sm:text-5xl">
                    Certificate and Acheviments
                  </h2>
                  <p className="text-muted-foreground md:text-base/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                    I believe in collaboration and continuous learning. I stay engaged with various
            ...
            <BlurFade delay={BLUR_FADE_DELAY * 13}>
              <div className="flex flex-col items-center justify-center space-y-4 text-center">
                <div className="space-y-2">
                  ...
                  <p className="text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                    A showcase of my achievements — from course completions and job simulations to hackathon participation.
                  </p>
                </div>
              </div>
            </BlurFade>
              ...
              <div className="space-y-4">
                ...
                <p className="mx-auto max-w-[600px] text-muted-foreground text-sm/relaxed md:text-base/relaxed">
                  ...
                  <Link
                    ...
                    className="text-foreground hover:underline"
                  >
                    <span className="text-muted-foreground text-sm/relaxed md:text-base/relaxed">drop a mail : {" "}</span>
                    {DATA.email}
                  </Link>
                  .
                </p>
